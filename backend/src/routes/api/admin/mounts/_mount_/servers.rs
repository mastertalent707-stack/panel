...
mod get {
    ...
    use shared::{
        ApiError, GetState,
        models::{
            Pagination, PaginationParamsWithSearch, server_mount::ServerMount,
    ...
    struct Response {
        #[schema(inline)]
        server_mounts: Pagination<shared::models::server_mount::AdminApiServerServerMount>,
    }
    ...
    pub async fn route(
        ...
        let server_mounts = ServerMount::by_mount_uuid_with_pagination(
            &state.database,
            mount.uuid,
            params.page,
            params.per_page,

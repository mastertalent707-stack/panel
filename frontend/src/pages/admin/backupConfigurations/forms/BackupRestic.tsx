...
import { adminBackupConfigurationResticSchema } from "@/lib/schemas";

export default function BackupRestic({ form }: {
    ...
    <Stack gap="xs">
      ...
      <Stack>
        ...
        <PasswordInput
          ...
          onChange={(e) =>
            form.setFieldValue("environment.RESTIC_PASSWORD", e.target.value)
          }
        />

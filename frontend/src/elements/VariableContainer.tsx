...
export default ({ variable, overrideReadonly = false, doUpdate }: {
  ...
  return (
    <Card className={"flex flex-col justify-between rounded-md p-4 h-full"}>
      ...
      <Group pt={"md"} mt={"auto"}>
        <Button
          disabled={(!variable.isEditable && !overrideReadonly) || (variable.rules.includes("required") && !value) || value === serverValue}
